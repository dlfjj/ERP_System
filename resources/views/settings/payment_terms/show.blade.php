...
@section('page-crumbs')
	<ul id="breadcrumbs" class="breadcrumb">
		...
		<li>
			<a href="/settings/payment_terms">Payment Terms</a>
		</li>
		<li class="current">
			<a href="/settings/payment_terms/{{ $payment_term->id }}" title="">Detail</a>
		</li>
	</ul>
	...
	<div class="col-md-12">
		<div class="widget box">
			...
			<div class="widget-content">
                {!! Form::open(['method'=>'PUT', 'action'=> ['PaymentTermController@update', $payment_term->id], 'class'=>'form-horizontal row-border form-validate','enctype'=>'multipart/form-data']) !!}
                {{--<form enctype="multipart/form-data" id="main" class="form-horizontal row-border form-validate" action="" method="POST">--}}
					...
					<div class="form-group">
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-md-2">
									{{ Form::input('number','sort_no', $payment_term->sort_no, array("class"=>"form-control","step"=>"1")) }}
					...
					<div class="form-actions">
						...
						<a href="/settings/payment_terms" class="btn btn-default pull-right">Cancel</a>
					</div>
                {{ Form::close() }}
            </div>
			{{--</form>--}}
