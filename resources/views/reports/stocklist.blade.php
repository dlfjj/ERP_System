...
@section('page-crumbs')
	<ul id="breadcrumbs" class="breadcrumb">
		...
		<li><a href="/reports/">Reports</a></li>
		<li><a href="/reports/stocklist">Stocklist</a></li>
	</ul>
				...
				<table class="table table-hover">
					<thead>
						<tr>
							...
							<th>Location</th>
							<th>Stock Qty</th> 
							<th class="cell-tight">Amount 20' {{ $currency_code }}</th>
							<th class="cell-tight">Amount 40' {{ $currency_code }}</th>
						</tr>
					</thead>
					<tbody>
<?php
...
?>
	...
	?>
										...
										<tr>
											...
											<td>{{ $product->mpn }}</td>
											<td><a href="/products/show/{{$product->id}}">{{substr($product->product_name,0,50) }}</a></td>
