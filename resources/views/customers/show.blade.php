...
<div class="row">
			...
			{!! Form::open(array("url"=>"/customer/destroy/$customer->id","method"=>"post","class"=>"form-inline","id"=>"delete")) !!}
	...
	<div class="col-md-12">
		...
		<div class="widget box">
			...
			<div class="widget-content">
					...
					{!! Form::open(array('url' => "/customer/$customer->id", 'enctype' => 'multipart/form-data', 'id' => 'main', 'method' => 'post', 'class' => 'form-vertical row-border form-validate', 'autocomplete' => 'off')) !!}
    ...
    @endif
							...
							<td class="align-right">
								...
								<span class="btn-group">
									...
									{!! Form::open(array('url' => "/customer/contact-delete/$contact->id", 'enctype' => 'multipart/form-data', 'id' => "contact-delete-$contact->id", 'method' => 'post', 'class' => 'form-inline', 'autocomplete' => 'off')) !!}

										<a href="javascript:void(0);" class="btn btn-xs form-submit-conf"><i class="icon-trash"></i></a>

										<a href="/customer/contact-edit/{{$contact->id}}" class="btn btn-xs"><i class="icon-edit"></i></a>
						...
						<tr>
							...
							<td class="align-right">
								...
								<span class="btn-group">
									...
									{!! Form::open(array('url' => "/customer/address-delete/$address->id", 'enctype' => 'multipart/form-data', 'id' => "address-delete-$address->id", 'method' => 'post', 'class' => 'form-inline', 'autocomplete' => 'off')) !!}

										<a href="javascript:void(0);" class="btn btn-xs form-submit-conf"><i class="icon-trash"></i></a>

										<a href="/customer/address-edit/{{$address->id}}" class="btn btn-xs"><i class="icon-edit"></i></a>
...
<div class="modal fade" id="modal_add_contact">
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			{!! Form::open(array('url' => "/customer/contact-add", 'enctype' => 'multipart/form-data', 'id' => "addresscustomer_contact", 'method' => 'post', 'class' => 'form-validate1', 'autocomplete' => 'off')) !!}
...
<div class="modal fade" id="modal_add_address">
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			{!! Form::open(array('url' => '/customer/address-add', 'enctype' => 'multipart/form-data', 'id' => 'customer_address', 'method' => 'post', 'class' => 'form-validate2')) !!}
...
<div class="row">
	...
	<div class="col-md-12 no-padding">
		...
		<p class="record_status">Created: {{$customer->created_at}} | Created by: {{$created_by_user}} | Updated: {{$customer->updated_at}} | Updated by: {{$updated_by_user}} | <a href="/customers/changelog/{{ $customer->id }}">Changelog</a></p>
