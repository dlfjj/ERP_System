...
<div class="box">
	...
	<!-- {!! Form::open(array('url' => '/auth/save', 'method' => 'post', 'class' => 'form-vertical login-form')) !!} -->
		...
		<div class="form-group">
            ...
            $companies = App\Models\Company::where('can_login',1)->where('status','Active')->pluck("letter","id");
            @endphp
			<!-- <select name = "company_id" class="form-control">
				...
				{!! Form::select('company_id',$companies,"", $company_options) !!}
{{--				{!!Form::select('company_id',['1','2','3'],'',['class'=>'form-control'])!!}--}}
	...
	<div class="form-actions">
        ...
        -->
		<button type="submit" class="submit btn btn-primary pull-right" style="margin-right: 10px;">
