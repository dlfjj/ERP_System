            ...
            <div class="col-xs-12">
                ...
                <table class="table table-bordered table-highlight-head table-invoice">
                    ...
                    @if($order->discount != 0)
                        ...
                        <tr>
                            <td colspan="5" align="right">Subtotal: {{ $order->currency_code }} {{ number_format($order->sub_total_net,2) }}</td>
                        </tr>
                    @endif
                    @if($order->shipping_cost > 0)
                        <tr>
                            <td colspan="5" align="right">Freight Charge:  {{ $order->currency_code }} {{ number_format($order->shipping_cost,2) }}</td>
                        </tr>
                    @endif
                    ...
                    @endif
                    <tr>
                        <td colspan="5" align="right" >Total amount: {{ $order->currency_code }} {{ number_format($order->total_gross,2) }}</td>
                    </tr>
