	...
	<div class="col-md-12">
		<div class="widget box">
			...
			<div class="widget-content">
				<form enctype="multipart/form-data" id="main" class="form-horizontal row-border form-validate" action="/products/{{$product->id}}/change_status" method="POST">
						...
						<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-12">
									...
									{{ Form::select('status', array('DRAFT' => 'DRAFT','Pending' => 'Pending', 'ACTIVE' => 'ACTIVE','INACTIVE' => 'INACTIVE'), $product->status, array("class"=>"form-control")) }}
								</div>
							</div>
						</div>
					</div>
