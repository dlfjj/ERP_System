        ...
        <div class="col-md-12">
            <div class="widget box">
                ...
                <div class="widget-content">
                        {!! Form::open(['method'=>'PATCH','action'=>['StockController@update', $product->id]]) !!}
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    {{ Form::input('number','stock_min', "",['class' => 'form-control','step' => '1']) }}
                                </div>
                                <div class="col-md-2">
...
{{--                                    {{ Form::text('quantity', "", array("class"=>"form-control")) }}--}}
                                    {{ Form::input('number','quantity', "",['class' => 'form-control','step' => '1']) }}
