	...
	<div class="col-md-12">
		<div class="widget box">
			...
			<div class="widget-content">
				<form enctype="multipart/form-data" id="main" class="form-horizontal row-border form-validate" action="/products/{{$product->id}}/request" method="POST">
					<div class="form-group">
						<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-12">
									<h5>Are you sure you want to request to edit the Product with Part Number {{$product->part_number}}?</h5>
					...
					<div class="form-actions">
						<input type="submit" value="Request, sure" class="btn btn-success pull-right">
